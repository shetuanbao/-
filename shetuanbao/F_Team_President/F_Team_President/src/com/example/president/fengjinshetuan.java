...
public class fengjinshetuan extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jiechushetuan);
		fanhui=(TextView)findViewById(R.id.jiechushetuan_1);
	...
	private class thread_get extends Thread{
		@Override
		public void run(){
			namey=NetInfoUtil.getfengjinshetuan();
			imagey=NetInfoUtil.getshetuanpicture2();
	...
	private class thread_updata extends Thread{
		@Override
		public void run(){
			NetInfoUtil.updatajiechushetuan(jiechuname);
		}
	}
	...
	public void initBaseAdapter(){
		...
		listview=(ListView)findViewById(R.id.jiechushetuan_listview);
...
//				  
				 AlertDialog isExit=new AlertDialog.Builder(fengjinshetuan.this).create();
					...
					isExit.setButton("确定",
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									jiechuname=name[arg2];
									thread_updata tu=new thread_updata();
									tu.start();
									try{
										tu.join();
									}catch(Exception e){
									...
									Intent it=new Intent(fengjinshetuan.this,fengjinshetuan.class);
									finish();
									startActivity(it);
								}
							}
	...
	private class baseAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null)
			{
				...
				convertView =mInflater.inflate(R.layout.jiechushetuan_list, null);
				myViews.name = (TextView) convertView.findViewById(R.id.shetuanjiechu_list);
				myViews.touxiang = (ImageView) convertView.findViewById(R.id.jiechu_image);
