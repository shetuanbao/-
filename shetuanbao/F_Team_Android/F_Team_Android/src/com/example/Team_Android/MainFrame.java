		...
		public void onClick(View arg0) {
			...
			switch (mBtnid) {
				...
				case R.id.frame_bottomview_person :
					...
					initButtomBth();
					bottomviewPersonImageview.setImageResource(R.drawable.b_geren);
					bottomviewPersonTextview.setTextColor(Color.parseColor("#49c4d6"));
					break;
			}
		}
