...
public class huodongrenyusn extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.huodongrenyuan);
		fanhui=(TextView)findViewById(R.id.huodongrenyuan_fanhui);
	...
	public void initBaseAdapter()
	  {
		  ...
		  listview=(ListView)findViewById(R.id.huodongrenyuan_listview);
		  ...
		  listview.setOnItemClickListener(new AdapterView.OnItemClickListener(){ 
              ...
              int arg2, long arg3) {
					...
					//LinearLayout ll=(LinearLayout) view1.getChildAt(0);
					 ...
					 Intent it=new Intent(huodongrenyusn.this,huodongrenyuandeliebiao.class);
    ...
    {     //�ڲ��ࣺ������
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null)
			{
				...
				convertView =mInflater.inflate(R.layout.huodongrenyuan_list, null) ;
				
				myViews.name = (TextView) convertView.findViewById(R.id.huodongchengyuan_name);
