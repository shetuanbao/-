...
public class huodonglibiao extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		fanhui=(TextView)findViewById(R.id.huodongguanli_text1);
		...
		tianjia.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent it=new Intent(huodonglibiao.this,tianjiahuodong.class);
				finish();
				startActivity(it);
			}
		});
		  ...
		  listview.setOnItemClickListener(new AdapterView.OnItemClickListener(){ 
              ...
              int arg2, long arg3) {
					...
					//LinearLayout ll=(LinearLayout) view1.getChildAt(0);
					 ...
					 Intent it=new Intent(huodonglibiao.this,xiugaihuodong.class);
					 s=name1[arg2];
