...
public class user_lianxiwomen_dianhuaActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.geren_lianxiwomen_dianhua);
		...
		public void onClick(View v) {
			...
			case R.id.contact_main_1_image:
				...
				{//�Ϸ��򲦺�
					...
					user_lianxiwomen_dianhuaActivity.this.startActivity(intent);
				}
				else
				{//���Ϸ�����ʾ
					Toast.makeText(
							user_lianxiwomen_dianhuaActivity.this, //������
							"�绰���벻���ϸ�ʽ������", //��ʾ����
